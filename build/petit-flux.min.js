(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.PetitFlux = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
},{"../../modules/$":20}],7:[function(require,module,exports){
...
},{"../modules/$":20,"../modules/es6.object.to-string":33,"../modules/es6.promise":34,"../modules/es6.string.iterator":35,"../modules/web.dom.iterable":36}],8:[function(require,module,exports){
...
},{"./$":20,"./$.wks":31}],10:[function(require,module,exports){
...
},{"./$":20}],12:[function(require,module,exports){
...
},{"./$":20}],13:[function(require,module,exports){
...
},{"./$.ctx":10,"./$.iter":19,"./$.iter-call":16}],14:[function(require,module,exports){
...
},{"./$.assert":8}],17:[function(require,module,exports){
...
},{"./$":20,"./$.cof":9,"./$.def":11,"./$.iter":19,"./$.redef":22,"./$.wks":31}],18:[function(require,module,exports){
...
},{"./$":20,"./$.assert":8,"./$.cof":9,"./$.shared":25,"./$.wks":31}],20:[function(require,module,exports){
...
},{"./$":20,"./$.cof":9,"./$.ctx":10,"./$.dom-create":12,"./$.invoke":15}],29:[function(require,module,exports){
...
},{"./$":20,"./$.shared":25,"./$.uid":29}],32:[function(require,module,exports){
...
},{"./$":20,"./$.iter":19,"./$.iter-define":17,"./$.uid":29,"./$.unscope":30}],33:[function(require,module,exports){
...
},{"./$":20,"./$.cof":9,"./$.redef":22,"./$.wks":31}],34:[function(require,module,exports){
...
},{"./$":20,"./$.assert":8,"./$.cof":9,"./$.ctx":10,"./$.def":11,"./$.for-of":13,"./$.iter-detect":18,"./$.mix":21,"./$.same":23,"./$.set-proto":24,"./$.species":26,"./$.task":28,"./$.uid":29,"./$.wks":31}],35:[function(require,module,exports){
...
},{"./$":20,"./$.iter":19,"./$.iter-define":17,"./$.string-at":27,"./$.uid":29}],36:[function(require,module,exports){
...
},{"./$":20,"./$.iter":19,"./$.wks":31,"./es6.array.iterator":32}],37:[function(require,module,exports){
"use strict";var _interopRequireWildcard=function(s){return s&&s.__esModule?s:{"default":s}},_classCallCheck=function(s,e){if(!(s instanceof e))throw new TypeError("Cannot call a class as a function")};exports.__esModule=!0;var _isDisposable=require("./isDisposable"),_isDisposable2=_interopRequireWildcard(_isDisposable),CompositeDisposable=function(){function s(){for(var e=arguments.length,i=Array(e),o=0;e>o;o++)i[o]=arguments[o];_classCallCheck(this,s),Array.isArray(i[0])&&1===i.length&&(i=i[0]);for(var t=0;t<i.length;t++)if(!_isDisposable2["default"](i[t]))throw new Error("Expected a disposable");this.disposables=i,this.isDisposed=!1}return s.prototype.add=function(s){this.isDisposed?s.dispose():this.disposables.push(s)},s.prototype.remove=function(s){if(this.isDisposed)return!1;var e=this.disposables.indexOf(s);return-1===e?!1:(this.disposables.splice(e,1),s.dispose(),!0)},s.prototype.dispose=function(){if(!this.isDisposed){for(var s=this.disposables.length,e=new Array(s),i=0;s>i;i++)e[i]=this.disposables[i];this.isDisposed=!0,this.disposables=[],this.length=0;for(var i=0;s>i;i++)e[i].dispose()}},s}();exports["default"]=CompositeDisposable,module.exports=exports["default"];

},{"./isDisposable":41}],38:[function(require,module,exports){
"use strict";var _classCallCheck=function(e,s){if(!(e instanceof s))throw new TypeError("Cannot call a class as a function")},_createClass=function(){function e(e,s){for(var t=0;t<s.length;t++){var o=s[t];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(s,t,o){return t&&e(s.prototype,t),o&&e(s,o),s}}();exports.__esModule=!0;var noop=function(){},Disposable=function(){function e(s){_classCallCheck(this,e),this.isDisposed=!1,this.action=s||noop}return e.prototype.dispose=function(){this.isDisposed||(this.action.call(null),this.isDisposed=!0)},_createClass(e,null,[{key:"empty",enumerable:!0,value:{dispose:noop}}]),e}();exports["default"]=Disposable,module.exports=exports["default"];

},{}],39:[function(require,module,exports){
"use strict";var _interopRequireWildcard=function(s){return s&&s.__esModule?s:{"default":s}},_classCallCheck=function(s,e){if(!(s instanceof e))throw new TypeError("Cannot call a class as a function")};exports.__esModule=!0;var _isDisposable=require("./isDisposable"),_isDisposable2=_interopRequireWildcard(_isDisposable),SerialDisposable=function(){function s(){_classCallCheck(this,s),this.isDisposed=!1,this.current=null}return s.prototype.getDisposable=function(){return this.current},s.prototype.setDisposable=function(){var s=void 0===arguments[0]?null:arguments[0];if(null!=s&&!_isDisposable2["default"](s))throw new Error("Expected either an empty value or a valid disposable");var e=this.isDisposed,i=void 0;e||(i=this.current,this.current=s),i&&i.dispose(),e&&s&&s.dispose()},s.prototype.dispose=function(){if(!this.isDisposed){this.isDisposed=!0;var s=this.current;this.current=null,s&&s.dispose()}},s}();exports["default"]=SerialDisposable,module.exports=exports["default"];

},{"./isDisposable":41}],40:[function(require,module,exports){
"use strict";var _interopRequireWildcard=function(e){return e&&e.__esModule?e:{"default":e}};exports.__esModule=!0;var _isDisposable2=require("./isDisposable"),_isDisposable3=_interopRequireWildcard(_isDisposable2);exports.isDisposable=_isDisposable3["default"];var _Disposable2=require("./Disposable"),_Disposable3=_interopRequireWildcard(_Disposable2);exports.Disposable=_Disposable3["default"];var _CompositeDisposable2=require("./CompositeDisposable"),_CompositeDisposable3=_interopRequireWildcard(_CompositeDisposable2);exports.CompositeDisposable=_CompositeDisposable3["default"];var _SerialDisposable2=require("./SerialDisposable"),_SerialDisposable3=_interopRequireWildcard(_SerialDisposable2);exports.SerialDisposable=_SerialDisposable3["default"];

},{"./CompositeDisposable":37,"./Disposable":38,"./SerialDisposable":39,"./isDisposable":41}],41:[function(require,module,exports){
"use strict";function isDisposable(e){return Boolean(e&&"function"==typeof e.dispose)}exports.__esModule=!0,exports["default"]=isDisposable,module.exports=exports["default"];
...
},{"../internal/arrayEach":45,"../internal/baseEach":46,"../internal/createForEach":53}],44:[function(require,module,exports){
(function (global){
...
},{"./baseForOwn":48,"./createBaseEach":51}],47:[function(require,module,exports){
var createBaseFor=require("./createBaseFor"),baseFor=createBaseFor();module.exports=baseFor;

},{"./createBaseFor":52}],48:[function(require,module,exports){
...
},{"../object/keys":67,"./baseFor":47}],49:[function(require,module,exports){
...
},{"../utility/identity":69}],51:[function(require,module,exports){
...
},{"./getLength":54,"./isLength":58,"./toObject":61}],52:[function(require,module,exports){
...
},{"../lang/isArray":63,"./bindCallback":50}],54:[function(require,module,exports){
var baseProperty=require("./baseProperty"),getLength=baseProperty("length");module.exports=getLength;

},{"./baseProperty":49}],55:[function(require,module,exports){
...
},{"../lang/isNative":65}],56:[function(require,module,exports){
...
},{"./getLength":54,"./isLength":58}],57:[function(require,module,exports){
...
},{"../lang/isArguments":62,"../lang/isArray":63,"../object/keysIn":68,"./isIndex":57,"./isLength":58}],61:[function(require,module,exports){
...
},{"../internal/isArrayLike":56,"../internal/isObjectLike":59}],63:[function(require,module,exports){
...
},{"../internal/getNative":55,"../internal/isLength":58,"../internal/isObjectLike":59}],64:[function(require,module,exports){
...
},{"../internal/getNative":55,"../internal/isArrayLike":56,"../internal/shimKeys":60,"../lang/isObject":66}],68:[function(require,module,exports){
...
},{"../internal/isIndex":57,"../internal/isLength":58,"../lang/isArguments":62,"../lang/isArray":63,"../lang/isObject":66}],69:[function(require,module,exports){
function identity(t){return t}module.exports=identity;

},{}],70:[function(require,module,exports){
"use strict";var _createClass=require("babel-runtime/helpers/create-class")["default"],_classCallCheck=require("babel-runtime/helpers/class-call-check")["default"],_interopRequireDefault=require("babel-runtime/helpers/interop-require-default")["default"];Object.defineProperty(exports,"__esModule",{value:!0});var _lodash=require("./lodash"),_lodash2=_interopRequireDefault(_lodash),Action=function(){function e(t,a){_classCallCheck(this,e),this[0]=t,this[1]=a,this.name=t,this.value=a}return _createClass(e,null,[{key:"make",value:function(t){if(arguments.length>2)throw new Error("Invalid arguments.");return 2===arguments.length?new e(arguments[0],arguments[1]):t instanceof e?t:_lodash2["default"].isArray(t)?new e(t[0],t[1]):_lodash2["default"].isObject(t)?new e(t.name,t.value):void 0}}]),e}();exports["default"]=Action,module.exports=exports["default"];

},{"./lodash":73,"babel-runtime/helpers/class-call-check":3,"babel-runtime/helpers/create-class":4,"babel-runtime/helpers/interop-require-default":5}],71:[function(require,module,exports){
"use strict";var _createClass=require("babel-runtime/helpers/create-class")["default"],_classCallCheck=require("babel-runtime/helpers/class-call-check")["default"],_Promise=require("babel-runtime/core-js/promise")["default"],_interopRequireDefault=require("babel-runtime/helpers/interop-require-default")["default"];Object.defineProperty(exports,"__esModule",{value:!0});var _eventemitter3=require("eventemitter3"),_eventemitter32=_interopRequireDefault(_eventemitter3),_disposables=require("disposables"),_lodash=require("lodash"),_lodash2=_interopRequireDefault(_lodash),_action=require("./action"),_action2=_interopRequireDefault(_action),Context=function(){function e(){_classCallCheck(this,e),this.actionEmitter=new _eventemitter32["default"],this.storeEmitter=new _eventemitter32["default"],this.actions={},this.stores={}}return _createClass(e,[{key:"registerActionCreator",value:function(e,t){var r=this;_lodash2["default"].forEach(t,function(t,i){r.actions[e]=r.actions[e]||{},r.actions[e][i]=function(){_Promise.resolve(t.apply(void 0,arguments)).then(function(e){var t=_action2["default"].make(e);r.actionEmitter.emit(t.name,t.value)})["catch"](function(e){throw e})}})}},{key:"registerStore",value:function(e,t){var r=this,i="change";this.stores[e]={onChange:function(e){return r.storeEmitter.on(i,e),new _disposables.Disposable(function(){r.storeEmitter.removeListener(i,e)})}},t.setup(function(e,t){return r.actionEmitter.on(e,t),new _disposables.Disposable(function(){r.actionEmitter.removeListener(e,t)})},function(){r.storeEmitter.emit(i,t)})}}]),e}();exports["default"]=Context,module.exports=exports["default"];

},{"./action":70,"babel-runtime/core-js/promise":2,"babel-runtime/helpers/class-call-check":3,"babel-runtime/helpers/create-class":4,"babel-runtime/helpers/interop-require-default":5,"disposables":40,"eventemitter3":42,"lodash":44}],72:[function(require,module,exports){
"use strict";var _classCallCheck=require("babel-runtime/helpers/class-call-check")["default"];Object.defineProperty(exports,"__esModule",{value:!0});var Enum=function e(l){var s=this;_classCallCheck(this,e),l.forEach(function(e){s[e]=e})};exports["default"]=Enum,module.exports=exports["default"];

},{"babel-runtime/helpers/class-call-check":3}],73:[function(require,module,exports){
"use strict";var _interopRequireDefault=require("babel-runtime/helpers/interop-require-default")["default"];Object.defineProperty(exports,"__esModule",{value:!0});var _lodashLangIsArray=require("lodash/lang/isArray"),_lodashLangIsArray2=_interopRequireDefault(_lodashLangIsArray),_lodashLangIsObject=require("lodash/lang/isObject"),_lodashLangIsObject2=_interopRequireDefault(_lodashLangIsObject),_lodashCollectionForEach=require("lodash/collection/forEach"),_lodashCollectionForEach2=_interopRequireDefault(_lodashCollectionForEach);exports["default"]={isArray:_lodashLangIsArray2["default"],isObject:_lodashLangIsObject2["default"],forEach:_lodashCollectionForEach2["default"]},module.exports=exports["default"];

},{"babel-runtime/helpers/interop-require-default":5,"lodash/collection/forEach":43,"lodash/lang/isArray":63,"lodash/lang/isObject":66}],74:[function(require,module,exports){
"use strict";var _interopRequireDefault=require("babel-runtime/helpers/interop-require-default")["default"];Object.defineProperty(exports,"__esModule",{value:!0});var _context=require("./context"),_context2=_interopRequireDefault(_context),_action=require("./action"),_action2=_interopRequireDefault(_action),_enum=require("./enum"),_enum2=_interopRequireDefault(_enum),_eventemitter3=require("eventemitter3"),_eventemitter32=_interopRequireDefault(_eventemitter3),_disposables=require("disposables");exports["default"]={Context:_context2["default"],Action:_action2["default"],Enum:_enum2["default"],EventEmitter:_eventemitter32["default"],Disposable:_disposables.Disposable,CompositeDisposable:_disposables.CompositeDisposable},module.exports=exports["default"];

},{"./action":70,"./context":71,"./enum":72,"babel-runtime/helpers/interop-require-default":5,"disposables":40,"eventemitter3":42}]},{},[74])(74)
});